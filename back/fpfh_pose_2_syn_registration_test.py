...
if __name__ == '__main__':
    ...
    scene_path = 'E:/滤波后数据1.pcd'
    source_path = 'E:/滤波后数据5.pcd'

    # modelidx_list = [0, 3, 4]  # Scene1
    ...
    outlier_color = np.array([0, 0.3, 1])  #
    ...
    source, source_down, source_fpfh = prepare_dataset(source_path, voxel_size)
    ...
    for class_res in model_idx_list:
        ...
        model_trans_init[:3, 3:] = np.array([0.3, 0.4, 0]).reshape(3, -1)
