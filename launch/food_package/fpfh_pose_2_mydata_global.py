...
if __name__ == '__main__':
    ...
    # scene_path = 'C:/Users/yaohua-win/PycharmProjects/pythonProject/pose_sys_pnp/dataset/real_camera/bottle/8.ply'
    # scene_path = 'C:/Users/yaohua-win/PycharmProjects/pythonProject/pose_sys_pnp/dataset/real_camera/fountain2/2.ply'
    scene_path = 'C:/Users/yaohua-win/PycharmProjects/pythonProject/pose_sys/dataset/real_camera/scene1_2/2.ply'

    model_path = 'C:/Users/yaohua-win/PycharmProjects/pythonProject/pose_sys/dataset/real_camera/bottle3/8.ply'
    # model_path = 'C:/Users/yaohua-win/PycharmProjects/pythonProject/pose_sys_pnp/dataset/real_camera/fountain4/2.ply'
    ...
    # RANSAC parameter
    ransac_iter_num = 1000  # 评估距离大于此数视为外点
    ...
    if 1:
        ...
        model_trans_init[:3, 3:] = array([100.5, 0.5, -200]).reshape(3, -1)
        # source, source_down = load_model(model_path, model_trans_init, voxel_size)
        # source, source_down, source_fpfh = prepare_dataset(model_path, voxel_size)  # 在这里面加载的！！！
        source, source_down, source_fpfh = prepare_dataset(model_path, voxel_size, model_trans_init)  # 在这里面加载的！！！
        model_down_np = array(source_down.points)  # 模型点
        ...
        # print(len(source_feature))  # 不对了： 特征比模型点多
        ...
        for (m, n) in matches:  # m是最小距离  n是次小距离（或者一会加上过滤）
            ...
            if m.distance < flann_ratio * n.distance:  # 什么原理？ 最小的<0.7次小的
                ...
                # asarray(source_down.colors)[queryIdx, :] = [0, 1, 0]  # 模型  没用到
        ...
        draw_registration_result(source, target, res_icp, is_rgb, 'Global ICP')  # 粗配准后
