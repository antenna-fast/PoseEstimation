...
if __name__ == '__main__':
    ...
    model_root_path = '/Users/aibee/Downloads/Dataset/3DDataset/6DPose/CVLab/' \
                      'dataset1/dataset1-2_models/3D models/Stanford'
    ...
    for s in range(num_scenes):
        ...
        if 1:
            ...
            for i, model_name_rt in enumerate(model_info):  # get key
                ...
                # single model ransac
                res_ransac, loss, inlier_buff, outlier_buff, inlier_ratio = ransac_pose(model_paired, scene_paired, iter_num=ransac_iter_num, inlier_threshold=inlier_threshold)
