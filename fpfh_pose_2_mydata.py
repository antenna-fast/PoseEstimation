...
if __name__ == '__main__':
    ...
    # # match_line_color = [0, 1, 0]
    # match_line_color = [1, 0, 0]
    ...
    # RANSAC parameter
    ransac_iter_num = 260  # 评估距离大于此数视为外点
    ...
    for class_member_mask in seg_res_idx:  # [2:]:  # 去掉的是背景
        ...
        # 加载对应的模型
        model_path = model_root_cvlab + '3D Models/' + id_str + '/filted/' + class_encode[class_res]
